...
public class TeacherController {
    ...
    public Result add(@Valid @RequestBody Teacher teacher)  {
    ...
    @ApiImplicitParams({ @ApiImplicitParam(paramType = "query", dataType = "String", name = "q", value = "查询值",  required = false, example = "钟昌余")})
    public Result list(@RequestParam(required = false) String q) {
        // 1.获得所有教师记录
    ...
    public Result updateTeacherBytId(@Valid @RequestBody Teacher teacher) {
